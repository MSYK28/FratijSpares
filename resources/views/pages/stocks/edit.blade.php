        ...
        <div class="col-md-8">
            <div class="card ">
                <div class="card-header ">
                    <h5 class="card-title">Update Stocks Details</h5>
                    <p class="card-category">Update stocks based on changing values</p>
                    <hr>
                </div>
                <div class="card-body ">
                    <form action="{{ url('/stocks') }}" method="post">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" id="quantity" class="form-control" name="quantity"
                                        value="{{ $stock->quantity }}" placeholder="Stock Quantity">
                                </div>
                            </div>
                        </div>
                        <div class="row d-flex justify-content-between">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" id="buying_price" class="form-control" name="buying_price"
                                        value="{{ $stock->buying_price }}" placeholder="Buying Price">
                                </div>
                            </div>
                        </div>
                        <div class="row d-flex justify-content-between">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" id="marked_price" class="form-control" name="marked_price"
                                        value="{{ $stock->marked_price }}" placeholder="Marked Price">
                                </div>
                            </div>
                        </div>
                        <div class="card-footer row justify-content-center">
                            ...
                            <div class="stats col-md-6">
                                <button type="submit" class="btn btn-md btn-primary">Update Stock</button>
                            </div>
                        </div>
                    </form>
                </div>
